		...
		<tbody>
			<?php do { ?>
				...
				<tr style="background-color: <?= $color ?>">
					...
					<td><a href="#" data-detalleaux="<?= $row_Listado['razonsocial'] . "-" . $row_Listado['ruc'] ?>"  data-proveedor="<?= $row_Listado["codigoproveedor"] ?>" data-estado="<?= $estado ?>" data-codigo="<?= $row_Listado['codigo'] ?>" class="verOrden">Ver</a></td>
			...
			<div class="modal-content m-auto">
				...
				<div class="modal-body">
					<form id="saveOrdenCompra-alm-list">
						...
						<input type="hidden" id="proveedormodal">
						...
						<div style="display: flex; justify-content: space-between;">
							...
							<button type="submit" id="btn-guardarGuia-alm-list" class="btn btn-success">RECIBIDO</button>
						</div>
