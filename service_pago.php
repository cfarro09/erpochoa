...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "Eliminar_Registro")) {
  $updateSQL = sprintf("UPDATE serviciosapagar SET estado=%s WHERE codigosap=%s",
...
mysql_select_db($database_Ventas, $Ventas);
$query_Listado = "SELECT a.codigosap, a.nrecibo, a.monto, a.femision, a.fpago,b.nombre FROM serviciosapagar a INNER JOIN servicios b ON a.codigosv = b.codigosv WHERE a.estado = 0";
