            ...
            <div class="modal-content m-auto">
                <form id="formoperacion" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" aria-label="Close" onClick="devolver()">Guardar</button>
        ...
        const devolver = () => {
            ...
            getSelectorAll(".inputdevo").forEach(ix =>{
                if(ix.value){
                    ...
                    data.detalle.push(`update detalle_ventas set devolucion = 1, cantdevolucion = ${ix.value}, historialdevolucion = '${historialdevolucion}' where codigodetalleproducto = ${iddetalle}`)
                }
                ...
                if(res){
                    ...
                    res.forEach(ix => {
                        ...
                        if(ix.devolucion && parseInt(ix.devolucion) > 0){
                            devoler = `<span class="btn btn-danger" data-historial='${ix.historialdevolucion}' data-iddetalle="${ix.codigodetalleproducto}" onClick="cancelardevolucion(this)" data-idventa="${e.dataset.id}">${ix.cantdevolucion} Cancelar</span>`
                        }else{
                            devoler = `<input type="number" data-historial='${ix.historialdevolucion}' data-iddetalle="${ix.codigodetalleproducto}" data-idventa="${e.dataset.id}" class="form-control inputdevo" oninput="validatenumber(this)" data-max="${ix.cantidad}" style="width: 100px">`
                        }
                        detallebody.innerHTML += `
                        <tr>
