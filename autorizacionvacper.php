...
mysql_select_db($database_Ventas, $Ventas);
$query_Listado = "SELECT * FROM personal_vacaciones pv inner join personal p on p.codigopersonal=pv.codigopersonal";
  ...
  <tbody>
    ...
    <tr style="background-color: <?= $color; ?>">
      ...
      <td><a
          ...
          data-toggle="modal"> <?php echo $row_Listado['cedula']; ?> </a> </td>
           <td><a
          onClick="abre_ventana('Emergentes/<?php echo $editar?>?codigoprod=<?php echo $row_Listado['codigoprod']; ?>',<?php echo $popupAncho?>,<?php echo $popupAlto?>)"
          data-toggle="modal"> <?php echo $row_Listado['nombre'].' '.$row_Listado['paterno'].' '.$row_Listado['materno']; ?> </a> </td>
      <td><a
          onClick="abre_ventana('Emergentes/<?php echo $editar?>?codigoprod=<?php echo $row_Listado['codigoprod']; ?>',<?php echo $popupAncho?>,<?php echo $popupAlto?>)"
          data-toggle="modal"> <?php echo $row_Listado['tipo']; ?> </a> </td>

      <td><a
          onClick="abre_ventana('Emergentes/<?php echo $editar?>?codigoprod=<?php echo $row_Listado['codigoprod']; ?>',<?php echo $popupAncho?>,<?php echo $popupAlto?>)"
          data-toggle="modal"> <?php echo $row_Listado['fecha_inicio']; ?> </a> </td>
       <td><a
          onClick="abre_ventana('Emergentes/<?php echo $editar?>?codigoprod=<?php echo $row_Listado['codigoprod']; ?>',<?php echo $popupAncho?>,<?php echo $popupAlto?>)"
          data-toggle="modal"> <?php echo $row_Listado['fecha_fin']; ?> </a> </td>
