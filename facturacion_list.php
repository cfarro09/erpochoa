		...
		<tr style="background-color: <?= $color ?>">
			...
			<td>
				<a href="#" data-type="guia_sin_oc" onclick="visualizar(this)"
					...
					data-codigorc="<?= $row_Listado['codigorc'] ?>" class="verOrdenSinOc">Ver</a>
			</td>
			<?php else: ?>
											...
											<div class="col-md-2 container_cambio" id="container_cambio"
												...
												<div class="form-group">
													...
													<input type="number" min="1" value="1" step="any"
														class="form-control" id="tipocambio"
				...
				<div style="margin-top: 10px" class="divxx div_estibador">
					...
					<div class="row" style="display: none" id="container_estibador">
						<div class="col-sm-6">
							...
							<select name="proveedor" id="proveedorestibador" required
								class="form-control select2 tooltips" id="single" data-placement="top"
								data-original-title="Seleccionar proveedor">
						...
						<div class="col-sm-3">
							...
							<select class="form-control" data-container="containertipocambioestibador"
								onchange="changetipomoneda(this)" id="monedaestibador" name="monedaestibador" required>
						...
						<div class="col-sm-3" id="containertipocambioestibador" style="display: none">
							...
							<input class="form-control" type="number" value="1" min="1" step="any"
								id="tipocambioestibador">
						</div>
						<div class="col-sm-3">
				...
				<div style="margin-top: 10px" class="divxx div_notadebito">
					...
					<div class="row" style="display: none" id="container_notadebito">
						<div class="col-sm-6">
							...
							<select name="proveedor" id="proveedornotadebito" required
								class="form-control select2 tooltips" id="single" data-placement="top"
								data-original-title="Seleccionar proveedor">
								<option value="">Seleccione</option>
								<?php do {  ?>
						...
						<div class="col-sm-3">
							...
							<select class="form-control" data-container="containertipocambionotadebito"
								onchange="changetipomoneda(this)" id="monedanotadebito" name="monedanotadebito"
								required>
								<option value="soles">S/</option>
								<option value="dolares">$</option>
							</select>
				...
				<div style="margin-top: 10px" class="divxx div_notacredito">
					...
					<div class="row" style="display: none" id="container_notacredito">
						<div class="col-sm-6">
							...
							<select name="proveedor" id="proveedornotacredito" required
								class="form-control select2 tooltips" id="single" data-placement="top"
								data-original-title="Seleccionar proveedor">
								<option value="">Seleccione</option>
								<?php do {  ?>
						...
						<div class="col-sm-3">
							...
							<select class="form-control" data-container="containertipocambionotacredito"
								onchange="changetipomoneda(this)" id="monedanotacredito" name="monedanotacredito"
								required>
								<option value="soles">S/</option>
								<option value="dolares">$</option>
							</select>
						...
						<div class="row">
							<div class="row">
								<div class="col-sm-6">
									...
									<select name="proveedor" id="proveedorpro" required
										class="form-control select2 tooltips" id="single" data-placement="top"
										data-original-title="Seleccionar proveedor">
										<option value="">Seleccione</option>
										<?php do {  ?>
										<option
											value="<?= $row_Clientes['razonsocial'] . '&&&' .$row_Clientes['ruc']?>">
											<?= $row_Clientes['razonsocial'] . ' ' .$row_Clientes['ruc']?>
										</option>
										<?php
										} while ($row_Clientes = mysql_fetch_assoc($Clientes));
							...
							<div class="row" style="margin-top: 10px">
								...
								<div class="col-sm-3" id="containerTipoCambio" style="display: none">
									...
									<input type="number" class="form-control" value="1" min="1" step="any"
										name="tipocambiopro" id="tipocambiopro" oninput="changepeso(preciopro)">
								</div>
								<div class="col-sm-3">
