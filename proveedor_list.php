      ...
      <?php do { ?>
        <tr>
          ...
          <td> 
           ...
           <td> 
            <a href="proveedor_comprobante.php?codigoproveedor=<?php echo $row_Listado['codigoproveedor']; ?>" class="btn yellow-casablanca tooltips" data-placement="top" data-original-title="Registro Comprobantes"><i class="glyphicon glyphicon-credit-card" ></i></a>          </td> 
          <td> 
