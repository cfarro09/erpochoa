...
if ((isset($_POST["MM_GuardarVenta"])) && ($_POST["MM_GuardarVenta"] == "GuardarVenta")) {	
  ...
  if($_POST['codigoclienten']==NULL && $_POST['codigoclientej']==NULL || $_POST['cambio']==NULL ){ ?>    <script type="text/javascript">
  ...
  if($_POST['codigoclientej']==NULL)
    $cjuridico=0;
  else
    $cjuridico=$_POST['codigoclientej'];
 ...
 $insertSQL = sprintf("insert into ventas values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
              GetSQLValueString(NULL, "text"),
						  ...
						  GetSQLValueString($cjuridico, "int"),
...
<input type="text" name="totalc" id="totalc" align="center"  readonly="readonly" value="<?php echo number_format($totalc,2);?>"  size="8" hidden="true"  />
</h5></td>
</tr>
<tr>
<td colspan="2">
