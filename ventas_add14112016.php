...
if ((isset($_POST["MM_GuardarVenta"])) && ($_POST["MM_GuardarVenta"] == "GuardarVenta")) {	
 ...
 $insertSQL = sprintf("insert into ventas values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
						  ...
						  GetSQLValueString($_POST['montofact'], "float"));
...
<td valign="top" align="right">
<h5 class="font-red-mint"><strong>$. <?php echo number_format($subtotal,2); ?><input type="text" name="subtotal" id="subtotal" align="center"  readonly="readonly" value="<?php echo number_format($subtotal,2);?>"  size="8" hidden="true"  /></strong></h5></td>
</tr>
<tr>
<td valign="top" align="right">
...
<td valign="top" align="right">
<h5 class="font-red-mint"><strong><?php echo number_format($total,2);?><input type="text" name="total" id="total" align="center"  readonly="readonly" value="<?php echo number_format($total,2);?>"  size="8" hidden="true"  /></h5></td>
</tr>
<tr>
<td colspan="2">
