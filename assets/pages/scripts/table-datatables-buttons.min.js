var TableDatatablesButtons=function(){var e=function(){var e=$("#sample_1");e.dataTable({language:{aria:{sortAscending:": activate to sort column ascending",sortDescending:": activate to sort column descending"},emptyTable:"No data available in table",info:"Visualizando _START_ de _END_ de _TOTAL_ Registros",infoEmpty:"No entries found",infoFiltered:"",lengthMenu:"_MENU_ Registros",search:"Buscar:",zeroRecords:"SIN RESULTADOS"},buttons:[{extend:"print",className:"btn dark btn-outline",text:"IMPRIMIR"},{extend:"copy",className:"btn red btn-outline",text:"COPIA"},{extend:"pdf",className:"btn green btn-outline" ,text:"PDF"},{extend:"excel",className:"btn yellow btn-outline ",text:"EXCEL"},{extend:"csv",className:"btn purple btn-outline ",text:"CVS"},{extend:"colvis",className:"btn dark btn-outline",text:"COLUMNAS"}],responsive:!0,order:[[0,"asc"]],lengthMenu:[[5,10,15,20,-1],[5,10,15,20,"All"]],pageLength:10,dom:"<'row' <'col-md-11'B>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>"})},
