...
class PDF extends FPDF
{
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(40,7, utf8_decode($fila['codigoprod']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['nombre_producto']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['cantidad']),0, 0 , 'L' );
