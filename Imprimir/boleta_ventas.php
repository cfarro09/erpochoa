...
mysql_select_db($database_Ventas, $Ventas);
$query_Listado_Productos = sprintf("SELECT a.codigodetalleproducto, a.codigo, a.codigoprod, a.cantidad, a.pventa, a.concatenacion, a.codcomprobante, b.nombre_producto AS Producto, c.nombre AS Marca, d.nombre_presentacion AS Presentacion, e.nombre_color AS Color FROM detalle_ventas a INNER JOIN producto b ON a.codigoprod = b.codigoprod INNER JOIN marca c ON b.codigomarca = c.codigomarca INNER JOIN presentacion d ON b.codigopresent = d.codigopresent INNER JOIN color e ON b.codigocolor = e.codigocolor WHERE codigo = %s", GetSQLValueString($colname_Listado_Productos, "text"));
  ...
  <tbody>
    <tr>
      <td width="33%" valign="top"><strong class="font-ms font-blue-soft">Facturado a:</strong><br>
          <span class="font-xs font-blue-chambray"><?php echo $row_Factura['ClienteNatural']; ?></span><br>
          <?php echo $row_Factura['direccion']; ?><br>
          <?php echo $row_Factura['ciudad']; ?><br>
          <br></td>
      <td width="33%" valign="top"><strong class="font-ms font-blue-soft">C&oacute;digo Cliente:</strong> 
          <span class="font-xs font-blue-chambray"><?php echo $row_Factura['codigoclienten']; ?></span></td>
      <td width="33%" valign="top"><strong class="font-ms font-blue-soft">C&oacute;digo Vendedor:</strong> 
          <?php echo $row_Factura['codigopersonal']; ?><span class="font-xs font-blue-chambray"></span><br>
...
<td>
    <table width="100%" border="1" >
      <tbody>
        <tr>
          <td width="10%" align="center" valign="middle"><strong class="font-ms font-blue-soft">C&oacute;digo</strong></td>
          <td width="10%" align="center" valign="middle"><strong class="font-ms font-blue-soft">Cantidad</strong></td>
          <td width="10%" align="center" valign="middle"><strong class="font-ms font-blue-soft">Presentaci&oacute;n</strong></td>
          <td width="45%" align="center" valign="middle"><strong class="font-ms font-blue-soft">Producto</strong></td>
          <td width="10%" align="center" valign="middle"><strong class="font-ms font-blue-soft">Valor Unitario</strong></td>
          <td width="15%" align="center" valign="middle"><strong class="font-ms font-blue-soft">Total</strong></td>
        </tr>
        <?php do { ?>
          <tr>
          <td><span class="font-xs font-blue-chambray"><?php echo $row_Listado_Productos['codigodetalleproducto']; ?></span></td>
          <td><span class="font-xs font-blue-chambray"><?php echo $row_Listado_Productos['cantidad']; ?></span></td>
...
//echo "<br>"; 
//echo "cambio = $cambio"; ?>
            <td colspan="6"><strong class="font-ms font-blue-soft">Son:</strong><span class="font-xs font-blue-chambray"><?php echo $cambio?></span></td>
            <?php 
...
<td><table width="100%" border="0">
  ...
  <tbody>
    <tr>
        ...
        <br><span class="font-xs font-blue-chambray">Somos Agentes de retencion del I.G.V</span>
        </td>
    </tr>
  </tbody>
</table>
      ...
      <td width="45%"><table width="100%" border="1">
        <tbody>
          <tr>
            <td valign="top"><p>&nbsp;</p>
              <p>aqui van todos los totales</p>
              <p>&nbsp;</p></td>
          </tr>
        </tbody>
      </table></td>
