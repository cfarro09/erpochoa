...
$querydetalle = "
    select 
    dv.*, v.*, p.nombre_producto, m.nombre as marca, CONCAT(c.paterno, ' ', c.materno, ' ', c.nombre) as ClienteNatural,
    ...
    inner join cnatural c on c.codigoclienten = v.codigoclienten
