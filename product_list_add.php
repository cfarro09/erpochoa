...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Ingresar")) {
  $insertSQL = sprintf("INSERT INTO producto (nombre_producto, codigomarca, codigocat, codigosubcat, codigocolor, codigopresent, descripcion, minicodigo, codigo2, codigo3) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <tr>
            <td width=33%><div class="col-md-10">
              <div class="form-group"><span id="spryselect3">
                <select name="codigomarca" id="codigomarca" required class="form-control tooltips" data-placement="top" data-original-title="Seleccionar Marca">
...
?>
            ...
            <td width=33%><div class="col-md-10">
              <div class="form-group"><span id="spryselect4">
                <select name="codigopresent" required id="codigopresent" class="form-control tooltips" data-placement="top" data-original-title="Seleccionar Presentaci&oacute;n">
...
?>
            ...
            <td width=33%><div class="col-md-10">
              <div class="form-group"><span id="spryselect5">
                <select required name="codigocolor" id="codigocolor" class="form-control tooltips" data-placement="top" data-original-title="Seleccionar Color">
