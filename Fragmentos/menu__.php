                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item ">
                           ...
                           <li class="nav-item"> 
                            <a href="principal01.php" class="nav-link font-blue-steel">
...
<li class="nav-item"> 
                        ...
                        <li class="nav-item"> 
                            <a href="javascript:;" class="nav-link font-blue-steel">
                                <i class="glyphicon glyphicon-cog  font-blue-steel"></i>
                            ...
                            <ul class="sub-menu">
                             <li class="nav-item">
                                    <a href="#" class="nav-link font-blue-ebonyclay">
                                        <i class="glyphicon glyphicon-briefcase  font-blue-ebonyclay"></i>
                             ...
                             <li class="nav-item">
                                    <a href="#" class="nav-link font-blue-ebonyclay">
                                        <i class="glyphicon glyphicon-folder-close   font-blue-ebonyclay"></i>
                                        <span class="title">Datos Sistema</span>
                                        <span class="selected"></span>
                                ...
                                <li class="nav-item">
                                    <a href="backup.php" class="nav-link font-blue-ebonyclay">
                                        <i class="glyphicon glyphicon-hdd  font-blue-ebonyclay"></i>
