                    ...
                    <div class="modal-content m-auto">
                        ...
                        <div class="modal-body">
                            <form id="msavesucursal">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($estado == "SUSPENDIDO") : ?>
                                                                    <a href="#" data-estado="3" data-cod="<?= $row_sucursales['cod_sucursal'] ?>" class="changeEstado">Eliminar</a>
                                                                <?php endif ?>

                                                                <a href="#" data-estado="<?= $estado == "ACTIVO" ? "2" : "1" ?>" data-cod="<?= $row_sucursales['cod_sucursal'] ?>" class="changeEstado"><?= $estado == "ACTIVO" ? "Suspender" : "Activar" ?></a>
                                                            </td>
                                                            <td>
                                ...
                                <button type="button" class="modal_close btn btn-danger" data-dismiss="modal">Cerrar</button>
                            </form>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="personal" onchange="selectpersonalx()" id="personalx" required class="form-control select2 tooltips" data-placement="top" data-original-title="Seleccionar personal">
                                                            ...
                                                            <?php $i++;
                                                            } while ($row_personalx = mysql_fetch_assoc($listado_personalx)); ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="field-1" class="control-label">Asignar
                                                            Surcusal</label>
                                                        <select name="sucursal" id="sucursal" required class="sucursal form-control select2 tooltips" data-placement="top" data-original-title="Seleccionar sucursal">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-check">
                                                                ...
                                                                <b><label class="" for="check_contable"><strong> Area contable</strong></label></b>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="">
                                            ...
                                            <tbody>
                                                <?php if ($totalRows_frases > 0) : ?>
                                                    ...
                                                    <?php $i++;
                                                    } while ($row_frases = mysql_fetch_assoc($frases)); ?>
                                                <?php endif ?>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="auto_guia_sin_oc_sinboton.php" class="nav-link font-blue-ebonyclay">
                                                ...
                                                <span class="title">S/Orden de Compra</span>
                                                <span class="selected"></span>
                            ...
                            <?php if ($accesos->check_logistica_almacen) : ?>
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="insumos_list.php" class="nav-link font-blue-ebonyclay">
                                                <i class="glyphicon glyphicon-log-in font-blue-ebonyclay"></i>
                                                <span class="title">Data Insumos</span>
                                                <span class="selected"></span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a href="servicios_add_list.php" class="nav-link font-blue-ebonyclay">
                                                <i class="glyphicon glyphicon-log-in font-blue-ebonyclay"></i>
                                                <span class="title">Data Servicios</span>
                                                <span class="selected"></span>
                                            </a>
                                        </li>
                            ...
                            <?php if ($accesos->check_comercial_compras) : ?>
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="new_ordencompra_add.php?codigo=<?php echo $_GET['codigo']; ?>" class="nav-link font-blue-ebonyclay">
                                                <i class="glyphicon glyphicon-log-in font-blue-ebonyclay"></i>
                            ...
                            <?php if ($accesos->check_comercial_ventas) : ?>
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="cajacheque.php" class="nav-link font-blue-ebonyclay">
                                                <i class="glyphicon glyphicon-log-in font-blue-ebonyclay"></i>
                                                <span class="title">Efectivo Caja Cheque</span>
                                                <span class="selected"></span>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="cuentascaja.php" class="nav-link font-blue-ebonyclay">
                                                <i class="glyphicon glyphicon-log-in font-blue-ebonyclay"></i>
                                                <span class="title">Data Bancos</span>
                                                <span class="selected"></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <script>
                            async function getcuentaabonadosG() {
                        ...
                        <script>
                            ...
                            document.querySelector("#saveManageUsuarios").addEventListener("submit", e => {
                                ...
                                if ((check_gerencia_autorizacion || check_gerencia_sucursales || check_gerencia_frase || check_logistica_almacen || check_logistica_edificaciones || check_logistica_personal || check_comercial_compras || check_comercial_cuentaspagar || check_comercial_ventas || check_comercial_cuentascobrar || check_comercial_cajaprincipal || check_contable) && personal && sucursal) {
                                    ...
                                    fetch(`saveAccesosSeguridad.php`, {
                                            method: 'POST',
                                            body: formData
                                        })
                                        .then(res => res.json())
