...
<div class="page-container">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="" for="check_gerencia_personal">Personal1</label>
                                                    </div>
                                                    <div class="form-check">
    ...
    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
        <?php if ($accesos && ($accesos->check_gerencia_autorizacion || $accesos->check_gerencia_sucursales || $accesos->check_gerencia_frase) ): ?>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item">
                                    <a href="new_ordencompra_add.php?codigo=<?php echo $_GET['codigo']; ?>"
                                        ...
                                        <i class="glyphicon glyphicon-signal font-blue-ebonyclay"></i>
                                        <span class="title">Generar Orden de compra</span>
                                        <span class="selected"></span>
                                    </a>
                                </li>
                                <li class="nav-item">
