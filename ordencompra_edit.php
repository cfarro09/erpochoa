...
<?php
  $codigoref2x = $_GET['codigoref2'];
  $codigoref1x = $_GET['codigoref1'];
  $codigoproveedorx = $_GET['codigoproveedor'];
...
/*
  ...
  */
          $insertSQL = sprintf("insert into ordencompra values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            GetSQLValueString(NULL, "text"),
              ...
              <tr>
                  ...
                  <tr>
                    <td width="95%" valign="top">
                      <div class="form-group" id="ClienteN" ><span id="spryselect5">
                        <select name="codigoproveedor" id="codigoproveedor" class="form-control select2 tooltips" id="single" data-placement="top" data-original-title="Seleccionar Comprobante" >
                          <optgroup label="Proveedores"> </optgroup>
                          <option value=""></option>
                          <?php
                          do {  
                            ?>
                            <option <?= $row_Clientes['codigoclienten'] == $codigoproveedorx ? "selected" : "" ?>  value="<?php echo $row_Clientes['codigoclienten'] ?>"><?php echo $row_Clientes['ClienteNatural']?></option>
                            <?php
                ...
                <tr>
                  <td>
                    ...
                    <span>
                      <input type="text" name ="docref1" id ="docref1" class="form-control tooltips" value="<?= $codigoref1x ?>"  data-placement="top" data-original-title="Documento Referencial 1" placeholder="Codigo Referencial 1"/>

                      <span class="textfieldRequiredMsg"></span></span>
                    </td>
                    <td>
                      <input type="text" name="docref2" id="docref2" class="form-control tooltips" data-placement="top" value="<?= $codigoref2x != "null" ? $codigoref2x : "" ?>" data-original-title="Documento Referencial 2" placeholder="Codigo Referencial 2">
