...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Ingresar")) {
  $insertSQL = sprintf("INSERT INTO hist_serv_atendidos (codigosv, codigosao, usuario_atendidos, personal_atendidos, fecha_atendidos, hora_atendidos, observacion_atendidos) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['codigosv'], "int"),
                       GetSQLValueString($_POST['codigosao'], "int"),
                       GetSQLValueString($_POST['usuario_atendidos'], "int"),
                       GetSQLValueString($_POST['personal_atendidos'], "int"),
                       GetSQLValueString($_POST['fecha_atendidos'], "date"),
                       GetSQLValueString($_POST['hora_atendidos'], "date"),
                       GetSQLValueString(strtoupper($_POST['observacion_atendidos']), "text"));
  ...
  $insertGoTo = "service_atended.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<input type="text" class="form-control tooltips" data-placement="top" data-original-title="Fecha Fin de Atenci&oacute;n" id="fecha_atendidos" name="fecha_atendidos" onKeyPress="return cancelWrite(event)" onKeyDown="return cancelWrite(event)" value="<?php echo date('Y-m-d');?>"/>
...
<div class="form-group col-md-6">
<div class="input-group input-group-lg">
<input type="text" class="form-control tooltips" data-placement="top" data-original-title="Hora Fin de Atenci&oacute;n" id="hora_atendidos" name="hora_atendidos" onKeyPress="return cancelWrite(event)" onKeyDown="return cancelWrite(event)" value="<?php echo date('h:i:s');?>"/>
<span class="input-group-btn">
...
<tr>
  ...
  <textarea name="observacion_atendidos" id="observacion_atendidos" rows="3" class="form-control tooltips" data-placement="top" data-original-title="Agregar Descripci&oacute;n u Observaci&oacute;n" placeholder="Descripción u Observación"></textarea>
...
<input name="estado_servicio" type="hidden" id="estado_servicio" value="A" />
<input name="usuario_atendidos" type="hidden" value="<?php echo $_SESSION['kt_login_id']; ?>" />
<input name="personal_atendidos" type="hidden" value="<?php echo $_SESSION['kt_codigopersonal']; ?>" />
<?php 
//------------- Inicio Botones------------
