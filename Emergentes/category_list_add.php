...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Ingresar")) {
  ...
  $insertGoTo = "category_list_add.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Ventas, $Ventas);
$query_Agregar = "SELECT * FROM categoria";
...
<input name="nombre" type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Nombre Categor&iacute;a" id="nombre" placeholder="Categoria" maxlength="200"  />
