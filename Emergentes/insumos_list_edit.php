...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "Ingresar")) {
  $updateSQL = sprintf("UPDATE insumo SET nombre_insumo=%s, codigomarca=%s, codigocolor=%s, codigopresent=%s, descripcion=%s WHERE codigoins=%s",
					   ...
					   GetSQLValueString($_POST['codigoins'], "int"));

  mysql_select_db($database_Ventas, $Ventas);
  $Result1 = mysql_query($updateSQL, $Ventas) or die(mysql_error());

  $updateGoTo = "insumos_list_edit.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_Producto = "-1";
if (isset($_GET['codigoins'])) {
  $colname_Producto = $_GET['codigoins'];
}
mysql_select_db($database_Ventas, $Ventas);
$query_Producto = "SELECT * FROM insumo WHERE codigoins = '$colname_Producto'";
...
$Icono="fa fa-cubes";
$Color="font-blue";
$Titulo="Editar Producto - ".$row_Producto['codigoins'];
...
<div class="form-group">
  ...
  <input name="nombre_producto" type="text" class="form-control tooltips" data-placement="top" data-original-title="Editar Nombre Producto" id="nombre_producto" placeholder="Nombre Producto" value="<?php echo $row_Producto['nombre_insumo']; ?>" maxlength="400"  />
...
<span class="selectInvalidMsg"></span><span class="selectRequiredMsg"></span></span></div>
  ...
  <input name="codigoins" type="hidden" id="codigoins" value="<?php echo $row_Producto['codigoins']; ?>">  
</table>
