...
<input name="nombre_color" type="text" class="form-control tooltips" id="nombre_color"  data-placement="top" data-original-title="Agregar Nombre de Color" placeholder="Color" maxlength="50"  />
