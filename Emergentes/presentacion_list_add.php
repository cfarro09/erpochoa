...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Ingresar")) {
  $insertSQL = sprintf("INSERT INTO presentacion (nombre_presentacion) VALUES (%s)",
  ...
  $insertGoTo = "presentacion_list_add.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Ventas, $Ventas);
$query_Agregar = "SELECT * FROM presentacion";
...
$Color="font-blue";
$Titulo="Agregar Presentac&iacute;on";
...
<input name="nombre_presentacion" type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Nombre de Presentaci&oacute;n" id="nombre_presentacion" placeholder="Presentac&iacute;on" maxlength="100"  />
