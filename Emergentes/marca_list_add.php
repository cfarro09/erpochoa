...
mysql_select_db($database_Ventas, $Ventas);
$query_Agregar = "SELECT * FROM marca";
...
<input name="nombre" type="text" class="form-control tooltips" id="nombre"  data-placement="top" data-original-title="Agregar Nombre Marca" placeholder="Marca" maxlength="100"  />
