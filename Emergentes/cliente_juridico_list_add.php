...
if (isset($_POST[$MM_flag])) {
  ...
  $LoginRS__query = sprintf("SELECT ruc FROM cjuridico WHERE ruc=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Ingresar")) {
  $insertSQL = sprintf("INSERT INTO cjuridico (ruc, razonsocial, fax, telefono, celular, contacto, email, fecha_registro, ciudad, direccion, obs) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "cliente_juridico_list_add.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$Color="font-blue";
$Titulo="Agregar Cliente Jurídico";
...
<div class="col-md-8">
<div class="input-group"><span id="sprytextfield2">
  <input type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Direccion" placeholder="Dirección" id="direccion" name="direccion" maxlength="80" />
  <span class="textfieldRequiredMsg"></span></span><span class="input-group-addon">
<i class="icon-pointer font-blue-soft"></i>
</span>
</div>
  ...
  <td><div class="form-group">
    <div class="col-md-4">
      <div class="input-group"><span id="sprytextfield8">
        <input type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Número de Celular" placeholder="Celular" id="celular" name="celular" maxlength="14" />
        <span class="textfieldRequiredMsg"></span><span class="textfieldMinCharsMsg"></span></span><span class="input-group-addon"> <i class="glyphicon glyphicon-phone font-blue-soft"></i> </span></div>
    </div>
  </div></td>
  <td><div class="form-group">
    <div class="col-md-10">
      <div class="input-group"><span id="sprytextfield5">
        <input type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Correo Electrónico" placeholder="Correo Electrónico" id="email" name="email" maxlength="100" />
