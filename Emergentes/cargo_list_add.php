...
mysql_select_db($database_Ventas, $Ventas);
$query_Agregar = "SELECT * FROM cargos";
...
<input name="cargo" type="text" class="form-control tooltips" data-placement="top" data-original-title="Agregar Nombre del cargo" id="cargo" placeholder="Cargo" maxlength="100"  />
