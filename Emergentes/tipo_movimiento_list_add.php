...
mysql_select_db($database_Ventas, $Ventas);
$query_Agregar = "SELECT * FROM tipomoviemiento";
...
$Color="font-blue";
$Titulo="Agregar Tipo de Movimiento";
...
<input name="nombre_tipomov" type="text" class="form-control tooltips" id="nombre_tipomov"  data-placement="top" data-original-title="Agregar Tipo de Movimiento" placeholder="Tipo de Movimiento" maxlength="100"  />
<span class="textfieldRequiredMsg"></span><span class="textfieldMinCharsMsg"></span></span><span class="input-group-addon">
<i class="glyphicon glyphicon-retweet font-blue-soft"></i>
</span>
</div>
</div>
</div>
