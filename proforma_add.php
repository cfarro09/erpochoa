...
if ((isset($_POST["MM_GuardarVenta"])) && ($_POST["MM_GuardarVenta"] == "GuardarVenta")) {	
 ...
 $insertSQL = sprintf("insert into proforma values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
window.location="proforma_list.php";
</script>
<?php
//$insertGoTo = "proforma_list.php";
...
$totalRows_Contador_Clientes = mysql_num_rows($Contador_Clientes);
  ...
  $insertSQL = sprintf("INSERT INTO detalle_ventas (codigo, codigoprod, pventa, concatenacion) VALUES (%s, %s, %s, %s)",
					   ...
					   GetSQLValueString($pventa, "double"),
...
<span id="sprytextfield2">
  <input name="numcomprobante" type="hidden" class="form-control tooltips "  id="numcomprobante" value=""  maxlength="16" data-placement="top" data-original-title="Numero Comprobante"/>
  <span class="textfieldRequiredMsg"></span></span>
</td>
<td><span id="sprytextfield3">
  <input  name="numerotc" type="hidden" class="form-control tooltips "  id="numerotc" value=""  maxlength="6" data-placement="top" data-original-title="Monto Recibido" onblur="calcularvuelto()" onblur="mensaje()" />
